...
public class ExecutePaymentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = siteMaps.getProperty(MyApplicationConstants.PaymentFeature.ERROR_PAGE);
        try {
                            ...
                            if (result) {
                                ...
                                if (feeChecking != null) {
                                    ...
                                    if (result) {
                                        ...
                                        url = siteMaps.getProperty(MyApplicationConstants.PaymentFeature.RECEIPT_PAGE);
                                    }
                                }
                            }
                        }
