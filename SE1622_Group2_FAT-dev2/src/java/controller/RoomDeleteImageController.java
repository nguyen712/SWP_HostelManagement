 ...
 * @author Bitano
 */
@WebServlet(name = "RoomDeleteImageController", urlPatterns = {"/RoomDeleteImageController"})
public class RoomDeleteImageController extends HttpServlet {
private static final String ERROR = "MainController?btn=Display+Image+Room&txtRoomId=";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id  = Integer.parseInt(request.getParameter("txtIdTmp"));
        int roomId  = Integer.parseInt(request.getParameter("txtRoomIdTmp"));
        String url = ERROR + roomId;
        try {
            RoomDAO dao = new RoomDAO();
            boolean check = dao.deleteImage(id);
            if (check) {
                url = SUCCESS + roomId;
            }
