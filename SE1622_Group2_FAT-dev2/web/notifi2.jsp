            ...
            <header class="top-header">
                <nav class="navbar navbar-expand gap-3">
                    ...
                    <form action="MainController" method="POST" class="searchbar">
                        ...
                        <input class="form-control" type="text" name="search" value="${param.search}" placeholder="Search for Notification">
                        <input type="hidden" value="Search Notification" name="btn" />
                            ...
                            <div class="border p-3 rounded">
                                ...
                                <form class="row g-3" action="MainController" method="POST">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="txtNotificationName" value="" placeholder="Enter Notification Name" class="box">

                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Notification Detail</label>
                                        <input type="text" class="form-control" name="txtNotificationDetail" value="" placeholder="Enter Notification Detail" class="box">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">User Name</label>
                                        <input type="text" class="form-control" name="txtUsername" value="" placeholder="Enter username" class="box">
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button type="submit" class="btn btn-primary" name="btn" value="Add Notification" class="btn">Send</button>
                                        </div>
                                    </div>
                                </form>
